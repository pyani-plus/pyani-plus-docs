...
This section describes different ways to install pyANI-plus on the most common operative systems such as Unix/Linux and macOS. 
...
Alternatively you can visit the [Release](https://github.com/pyani-plus/pyani-plus/releases) page and click on one of the available versions to get the source code. 

Once the download is complete, navigate to the repository:
