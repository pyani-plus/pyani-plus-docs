...
for bacteria. Adding `memory: 2G` or `mem_mb: 2048` under the
`default-resources` section would have used the full 2G RAM limit on
this queue to handle *slightly* larger genomes.
