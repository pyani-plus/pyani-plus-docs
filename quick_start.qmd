...
Further outputs can be generated from this database using `pyANI-plus` and the precise output will vary depending on the specific command used. At present, the software generates both graphical and tabular outputs:
