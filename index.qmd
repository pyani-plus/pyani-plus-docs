...
- [`ANIb`](subcommands/anib.qmd) (average nucleotide identity calculation using BLAST+)
- [`ANIm`](subcommands/anim.qmd) (average nucleotide identity calculation using MUMmer)
- [`dnadiff`](subcommands/dnadiff.qmd) (average nucleotide identity calculation using dnadiff)
- [`fastANI`](subcommands/fastani.qmd) (average nucleotide identity estimation using fastANI)
- [`sourmash`](subcommands/sourmash.qmd) (average nucleotide identity estiation using sourmash)
- [external-alignment](subcommands/external_alignment.qmd) (average nucleotide identity using multiple-sequence-alignment)
