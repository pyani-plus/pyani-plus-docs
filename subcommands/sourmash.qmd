# `sourmash` {#sourmash-subcommand .unnumbered}
...
`--scaled`:  Sets the compression ratio. [<span style="color:grey;">Default: 1000</span>] (<span style="color:green;">Integer range: $x\geq1$</span>)

`--kmersize`:   Comparison method k-mer size. [<span style="color:grey;">Default: 31</span>] (<span style="color:green;">Integer range: $x\geq1$</span>)
