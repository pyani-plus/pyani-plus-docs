# `fastani` {#fastani-subcommand .unnumbered}
...
`--kmersize`: Comparison method k-mer size. [<span style="color:grey;">Default: 16</span>] (<span style="color:green;">$1 \leq x \leq 16$
</span>)

`--minmatch`: Comparison method min-match. [<span style="color:grey;">Default: 0.2</span>] (<span style="color:green;">$0.0 \leq x \leq 1.0$
</span>)
